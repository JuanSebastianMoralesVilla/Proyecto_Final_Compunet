...
public interface ProductinventoryService {
	...
	public Iterable<Productinventory> findAll();
	 public Optional<Productinventory> findById(Integer id);
		//public Productinventory editPIR(Integer id,Productinventory productinventory, Integer productId);
		//public Productinventory savePIR(Productinventory productinventory, Integer productId ) ;
